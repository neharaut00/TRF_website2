      ...
      <div className="Domains">
          <div className="Electronics">
            <div className="Domain-content">
                    <p>The team that does the job of developing, creating, and researching circuit schematics and PCBs, analyzing various sensors and deciding their uses, programming the robot, and actuating it via all of this.                   
                    </p>
                </div>
            ...
            <svg width="226" height="196" viewBox="0 0 226 196" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* <image x="90" y="-65" width="128" height="146" xlink:href="../assets/Electronics.png'"/> */}
          ...
          <svg width="226" height="196" viewBox="0 0 226 196" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="Domain-content">
                  <p>The team that lays the framework for the creation of a structurally sound robot to begin. Designing these robots is no easy task itself,which is why it has been handed to this group of talented individuals.                     
                  </p>
              </div>
          </div>
          ...
          <div className="Software">
              <div className="Domain-content">
                  <p>TRF's programming arm, works in areas such as Android, image processing, machine learning, and web design, among others. The team has been doing research and industrial projects to delve further into these topics.                 
                  </p>
              </div>
