            ...
            {index === current && (
              ...
              <Col className="ImageCol" style={{padding: "0px"}} >
                <div className="FacultyImageDiv-neha">
                  ...
                  <svg className ="faculty_bg" width="300" height="400" viewBox="0 0 364 468" fill="none" >
                    ...
                    <defs>
                      <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                        <use href="#image0_13_874" transform="translate(0 -0.0628518) scale(0.00187617 0.00140713)"/>
                      </pattern>
                        <image id="image0_13_874" width="533" height="800" href={slide.image}/>
                    </defs>
                    </svg>                  
                </div>           
              </Col>
